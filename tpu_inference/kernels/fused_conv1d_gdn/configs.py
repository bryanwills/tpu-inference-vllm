...
class GDNConfigs:
    ...
    def get_scratch_shape_dict(self) -> dict[str, Any]:
        ...
        prev_conv_scratch = prev_recurrent_scratch = None
        # NOTE: Batched mode only supports where 1 seq = 1 tile. Therefore, inter
        ...
        return dict(
            ...
            prev_recurrent_scratch_ref=prev_recurrent_scratch,
        )
